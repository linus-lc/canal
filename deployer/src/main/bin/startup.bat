...
set kafka_jaas_conf=%conf_dir%\kafka_client_producer_jaas.conf
...
set KAFKA_OPTS= -Djava.security.auth.login.config="%kafka_jaas_conf%"

set JAVA_OPTS= %JAVA_MEM_OPTS% %JAVA_OPTS_EXT% %JAVA_DEBUG_OPT% %CANAL_OPTS% %KAFKA_OPTS%
